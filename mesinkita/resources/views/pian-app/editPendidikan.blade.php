...
@section('title', 'AdminLTE 3 | Edit Data Pendidikan')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('pian-app.updatependidikan', $pendidikan->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                <div class="form-group">
                    <label for="nama_pendidikan">Nama Pendidikan:</label>
                    <input type="text" class="form-control" id="pendidikan" name="nama"
